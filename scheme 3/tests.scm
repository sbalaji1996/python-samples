...
(define (a_lambda_function x) (begin (print x) (+ x 1)))
a_lambda_function
; expect (lambda (x) (begin (print x) (+ x 1)))

(cons 'one (cons 'two (cons 'three (cons 'four (cons 'five nil)))))
